<?php
class Learning_Marque_Model_Resource_Marque_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract{
     ...
     *
     * @return Learning_Marque_Model_Resource_Marque_Collection
     */
